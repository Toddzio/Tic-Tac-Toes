	...
	var playerScore = {0:0,1:0};
		{
			...
			var id = this.id;
					if(turn == 0) {
						...
						$(this).find('img').attr('src', 'Tic-Tac-Toes/assets/toe1crop.jpg')
						...
						$(this).find('img').removeAttr('src', 'Tic-Tac-Toes/assets/toe1crop.jpg')
						$(this).find('img').attr('src', 'Tic-Tac-Toes/assets/toe2crop.jpg')
						$(this).removeClass('hid')
						scoreArray[id] = 10;
						turn = turn -1
						tracker = tracker + 1
